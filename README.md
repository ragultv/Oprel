...
Install: `pip install oprel==0.7.1` | PyPI: https://pypi.org/project/oprel/0.7.1/
...
### System Requirements
Oprel runs on Linux, macOS, and Windows. For GPU acceleration, see the [Hardware & Deployment Guide](docs/external/hardware_guide.md) — it covers NVIDIA CUDA, AMD Vulkan/ROCm, Apple Metal, RAM and VRAM requirements, and hardware-tier recommendations. For installation modes, cache locations, API key handling, and server exposure guidance, see the [Safe Installation & Deployment Guide](docs/external/install_hardening.md). For details on where runtime binaries come from, how they are stored, and how future checksum verification could work, see the [Binary Provenance & Checksum Verification Guide](docs/external/binary_provenance.md).
...
[PyPI Page](https://pypi.org/project/oprel/0.7.1/)
